<template>
  <section class="post">
    ...
    <p>Whatever AGI may be, I’m convinced that with the current transformer architecture, the LLMs will never create as humans do. It’s clear that AI doesn’t actually think, but it mimics writing, drawing, and even music. It’s just <strong>mimicry</strong>, but on a masterful level.</p>
    <p>These systems possess a <strong>mathematical superpower</strong> of mimicry, something the humanity never thought possible before. It’s fascinating to see creativity and personal style translated into complex mathematical formulas. These formulas have become so intricate that we struggle to trace backward and understand why specific outputs occur. However, difficulty doesn’t equal magic, the process remains <strong>deterministic</strong>, precise, and limited to the data it was trained on and context.</p>
    ...
    <p>Don’t get me wrong; I still believe AI will replace many jobs. We tend to overestimate the complexity of our work, but the reality is that many people simply execute processes and follow <strong>protocols</strong>. We need to learn how to create, measure, adapt, and migrate between protocols, that will become our job.</p>
    <p>Our role will be to build protocols and set the direction while AI executes, observes, and reports. We will connect knowledge, create businesses, and experiment with new ideas. We will achieve greater results, our work will have a larger impact, and we will need fewer people to accomplish the same outcomes. This cycle will reinforce itself, reducing dependencies, removing obstacles, and driving even more <strong>productivity</strong>.</p>
    <p>All that productivity won’t come from AGI, there’s no magic in advanced mimicry. It’s simply another tool, much like the printing press, which drastically enabled the scaling of writing. Since LLMs are digital tools, the best way to use and scale them is through <strong>software</strong>.</p>
